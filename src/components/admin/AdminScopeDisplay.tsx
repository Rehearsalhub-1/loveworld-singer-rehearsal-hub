 ...
 *
 * - Shows the admin's LOCKED org as a non-clickable label
 * - No org switching — admin is locked to their ONE admin org
 * - Only shows church/subgroup switcher for managing sub-orgs
 * - HQ admins: shows HQ org label, no switcher needed for orgs
 */
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-slate-50 border border-slate-200/80">
        ...
        {/* Small lock indicator for non-HQ admins to show scope is fixed */}
        {!isHQAdmin && (
      ...
      {/* Church/Subgroup switcher — admin manages which church they're viewing */}
